...
import com.example.remotelist.mvvm.model.data.ShoppingList
...
val DocumentSnapshot.shoppingList: ShoppingList
    get() = this[SHOPPING_LIST] as ShoppingList? ?: throw ShoppingListNotFoundException()
